...
function [v_R,v_AAs_total,v_C,lambda,v,v_E,v_met,v_arg,v_leu,v_ilv,v_glt,v_trp,v_his,v_ser,v_lys,v_thr,v_phetyr,v_aro,v_cys,v_other,phi_E] = dCAFBA_AAs_core_v1(model,Dir,phi_AAs,phi_Rb,phi_met,phi_arg,phi_leu,phi_ilv,phi_glt,phi_trp,phi_his,phi_ser,phi_lys,phi_thr,phi_phetyr,phi_aro,phi_cys,phi_other,phi_C,w_E1,glyc_r,phi_Q,phiE_r,arg_r,aro_r,cys_r,glt_r,his_r,ilv_r,leu_r,lys_r,met_r,other_r,phetyr_r,ser_r,thr_r,trp_r,AAs_r)
