function [lambda,v,phi_E,model_t] = dCAFBA_AADown_Glyc_iML1515_post(model,coreState,coreInput)

% Refactored post-shift CAFBA solver for the iML1515 glycerol AA-downshift case.
