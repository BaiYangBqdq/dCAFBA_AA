...
LPproblem.A=[[model.S , Smixed] ; Sac];%%2022/03;A matrix containing the constraints coefficients.

LPproblem.b=bVec; % constraints rhs
LPproblem.ctype=ctypeVec; % constraint type; equal
