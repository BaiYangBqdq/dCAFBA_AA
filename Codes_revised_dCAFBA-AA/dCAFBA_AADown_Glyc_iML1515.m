%% This script simulates AA downshift using iML1515: Glycerol+18AAs-ser -> Glycerol
clear all
% close all
%% load model and data
load('AAshift_iML1515_glycerol.mat');
load('ExperimentalData.mat');
load('v_AAs_f_iML1515_glyc.mat');

model=changeRxnBounds(model,{'HPYRRx','TRSARr','HPYRI'},0,'b');%futile cycle 

%with serine: EX_ser_L_e_, 18AA
model1=changeRxnBounds(model,{'EX_ala__L_e','EX_arg__L_e','EX_asn__L_e','EX_asp__L_e','EX_glu__L_e','EX_gln__L_e','EX_gly_e','EX_his__L_e','EX_ile__L_e','EX_leu__L_e','EX_lys__L_e','EX_met__L_e','EX_phe__L_e','EX_pro__L_e','EX_ser__L_e','EX_thr__L_e','EX_val__L_e','EX_trp__L_e'},-1000,'l');
model1=changeRxnBounds(model1,{'EX_ala__L_e','EX_arg__L_e','EX_asn__L_e','EX_asp__L_e','EX_glu__L_e','EX_gln__L_e','EX_gly_e','EX_his__L_e','EX_ile__L_e','EX_leu__L_e','EX_lys__L_e','EX_met__L_e','EX_phe__L_e','EX_pro__L_e','EX_ser__L_e','EX_thr__L_e','EX_val__L_e','EX_trp__L_e'},0,'u');
model1=changeRxnBounds(model1,{'EX_cys__L_e','EX_tyr__L_e'},0,'b');

% % %18AA-minus-serine
% model1=changeRxnBounds(model,{'EX_ala__L_e','EX_arg__L_e','EX_asn__L_e','EX_asp__L_e','EX_glu__L_e','EX_gln__L_e','EX_gly_e','EX_his__L_e','EX_ile__L_e','EX_leu__L_e','EX_lys__L_e','EX_met__L_e','EX_phe__L_e','EX_pro__L_e','EX_thr__L_e','EX_val__L_e','EX_trp__L_e'},-1000,'l');
% model1=changeRxnBounds(model1,{'EX_ala__L_e','EX_arg__L_e','EX_asn__L_e','EX_asp__L_e','EX_glu__L_e','EX_gln__L_e','EX_gly_e','EX_his__L_e','EX_ile__L_e','EX_leu__L_e','EX_lys__L_e','EX_met__L_e','EX_phe__L_e','EX_pro__L_e','EX_thr__L_e','EX_val__L_e','EX_trp__L_e'},0,'u');
% model1=changeRxnBounds(model1,{'EX_cys__L_e','EX_tyr__L_e','EX_ser__L_e'},0,'b');
...
w_E1 = 4.25*10^-4;% MOPS+Glycerol+18AA
% w_E1 = 5.49*10^-4;% MOPS+Glycerol+18AA-minus-serine
w_E2 = 8.06*10^-4;
...
for i=2:length(t)
    if t(i)<0
        ...
        [lambda(i),v(:,i),phi_E(i),model_t_current] = dCAFBA_AADown_Glyc_iML1515_pre(model1,coreState,coreInput);
        ...
        [lambda(i),v(:,i),phi_E(i),model_t_current] = dCAFBA_AADown_Glyc_iML1515_post(model2,coreState,coreInput);
